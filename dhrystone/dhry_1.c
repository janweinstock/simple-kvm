  ...
  /* Main and Proc_0 in the Ada version             */
{
  ...
  Number_Of_Runs = 10000000L;

  ee_printf ("Execution starts, %lu runs through Dhrystone\n", Number_Of_Runs);
  ...
  {
#ifdef TIME
    Cycles = User_Time / Number_Of_Runs;
#else
    ...
    Dhrystones_Per_Second = ((float) HZ * (float) Number_Of_Runs)
                        / (float) User_Time;
#endif
    ee_printf ("Cycles for one run through Dhrystone: %lu\n", Cycles);
    ee_printf ("Overall cyles: %lu\n", User_Time);
  }
